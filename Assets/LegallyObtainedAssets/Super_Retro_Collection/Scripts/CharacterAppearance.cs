...
public class CharacterAppearance : MonoBehaviour
{
    ...
    public void animationUpdate()
    {
        ...
        if (movement.x > 0)
        {
            ...
            {
                //Debug.Log("Control stick is pointing right!");
        ...
        if (movement.x < 0)
        {
            if (horizontalInput < -0.1f)
            {
                //Debug.Log("Control stick is pointing left!");
        ...
        if (verticalInput > 0.1f)
        {
            if (movement.y > 0)
            {
                //Debug.Log("Control stick is pointing up!");
        ...
        if (movement.y < 0)
        {
            if (verticalInput < -0.1f)
            {
                //Debug.Log("Control stick is pointing down!");
                animator.SetInteger("orientation", 4);
            }
        }
    }
